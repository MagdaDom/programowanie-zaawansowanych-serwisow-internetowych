...
class InternalEvent extends Model
{
    ...
    public function setIsCancelled(bool $isCancelled): void { $this->isCancelled = $isCancelled; }

    public function getEventDateTime(): string { return $this->eventDateTime; }
    public function setEventDateTime(string $eventDateTime): void { $this->eventDateTime = $eventDateTime; }

    public function getPublishDateTime(): string { return $this->publishDateTime; }
    public function setPublishDateTime(string $publishDateTime): void { $this->publishDateTime = $publishDateTime; }
    ...
    public function setMetaTags(?string $metaTags): void { $this->metaTags = $metaTags; }
}