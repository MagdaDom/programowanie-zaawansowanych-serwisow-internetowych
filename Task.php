...
class Task extends Model
{
    ...
    public function setIsDone(bool $isDone): void { $this->isDone = $isDone; }
    ...
    public function getInternalEventId(): int { return $this->internalEventId; }
    public function setInternalEventId(int $internalEventId): void { $this->internalEventId = $internalEventId; }
}